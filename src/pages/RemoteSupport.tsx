                ...
                <div className="mb-8 p-4 bg-gray-50 rounded-md">
                  {activeTab === 'teamviewer' ? (
                    <div className="flex items-center">
                      <img src="https://upload.wikimedia.org/wikipedia/commons/9/90/TeamViewer_logo.svg" alt="TeamViewer Logo" className="h-10 mr-4" />
                      <div className="flex-grow">
                        <h3 className="font-bold mb-1">TeamViewer</h3>
                        <p className="text-sm text-gray-600 mb-2">Logiciel de télémaintenance sécurisé</p>
                      </div>
                      <a 
                    ...
                    <div className="flex items-center">
                      <img src="https://sparwan.com/cdn/shop/articles/RustDesk.webp?v=1718634087&width=487" alt="RustDesk Logo" className="h-10 w-10 mr-4" />
                      <div className="flex-grow">
                        <h3 className="font-bold mb-1">RustDesk</h3>
                        <p className="text-sm text-gray-600 mb-2">Alternative open-source pour l'assistance à distance</p>
                      </div>
                      <a 
