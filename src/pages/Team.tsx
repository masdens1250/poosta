      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              Découvrez comment HarounSolution a transformé les infrastructures informatiques de ces établissements entre 2011 et 2018 et comment ils accueillent avec enthousiasme son retour sous la forme de NetScolaire-DZ, une startup dédiée au secteur éducatif.
            </p>
          </div>
          ...
          <div className="mt-12 bg-white p-6 rounded-lg shadow-md">
            ...
            <p className="text-gray-700 mb-4">
              Après avoir fait ses preuves sous le nom de HarounSolution entre 2011 et 2018, notre équipe revient avec une vision renouvelée et une expertise encore plus ciblée pour le secteur éducatif. NetScolaire-DZ représente l'évolution naturelle de notre engagement envers les établissements scolaires de la région.
            </p>
