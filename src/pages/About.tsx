          ...
          <div className="flex flex-col md:flex-row items-center gap-12">
            ...
            <div className="md:w-1/2">
              ...
              <p className="text-gray-600 mb-6">
                {isRTL 
                  ? 'نت سكولير-دي زد، المعروف سابقاً باسم حارون سوليوشن، تأسست في عام 2011. اكتسبت حارون سوليوشن سمعة قوية بفضل احترافيتها في القطاع المدرسي وساهمت في تطوير البنية التحتية المعلوماتية للعديد من المؤسسات التعليمية في منطقة مستغانم.'
                  : "NetScolaire-DZ, autrefois connue sous le nom de HarounSolution, a été fondée en 2011. HarounSolution s'était déjà forgé une solide réputation grâce à son professionnalisme dans le milieu scolaire et avait contribué à l'implantation de l'infrastructure informatique de nombreux établissements scolaires de la région de Mostaganem."}
              </p>
              <p className="text-gray-600 mb-6">
                {isRTL
